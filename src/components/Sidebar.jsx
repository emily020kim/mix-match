...
const isActiveStyle = 'flex items-center bg-gray-500 px-5 py-4 gap-3 text-white font-bold border-r-2 border-gray-700 transition-all duration-200 ease-in-out capitalize';
    ...
    <div className='flex flex-col justify-between bg-gray-700 h-full overflow-y-scroll min-w-210 hide-scrollbar'>
      <div className='flex flex-col'>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <h3 className='mt-2 px-5 text-base text-white font-semibold 2xl:text-xl'>Categories</h3>
